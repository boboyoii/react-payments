...
var checkPrefixRangeMatches = (cardNumber, prefixRanges) => {
	return prefixRanges.some(({ length, min, max }) => {
		if (cardNumber.length < length) return false;
		const prefix = Number(cardNumber.slice(0, length));
		return prefix >= min && prefix <= max;
	}) ?? false;
};
var getCardNumberFormat = (cardBrand) => {
	return cardBrand ? CARD_BRANDS[cardBrand].format : DEFAULT_CARD_NUMBER_FORMAT;
};
var isFormatChanged = (currentFormat, nextFormat) => {
	return currentFormat.length !== nextFormat.length || currentFormat.some((length, index) => length !== nextFormat[index]);
};
var getFormattedValidityPeriodUnit = (validityPeriod) => {
	const { month, year } = validityPeriod;
	return `${month ? month + "/" : ""}${year ? year : ""}`;
};
var updateCardNumberUnitsFormat = (cardNumber, format) => {
...
var Card = (t0) => {
	...
	const cardNumberFormat = t1;
	let t2;
	if ($[3] !== validityPeriod) {
		t2 = getFormattedValidityPeriodUnit(validityPeriod);
		$[3] = validityPeriod;
		$[4] = t2;
	} else t2 = $[4];
	const cardValidityPeriodUnitString = t2;
	const t3 = cardCompany?.color;
	let t4;
	if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
		t4 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Chip, {});
		$[5] = t4;
	} else t4 = $[5];
	let t5;
	...
	let t10;
	if ($[11] !== cardBrand) {
		t10 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ChipWrapper, { children: [t4, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SwitchCase, {
			value: cardBrand,
			caseBy: t9,
			defaultCase: null
		})] });
	...
	let t11;
	if ($[13] !== cardNumberUnits) {
		t11 = cardNumberUnits.map(_temp2$2);
		$[13] = cardNumberUnits;
		$[14] = t11;
	} else t11 = $[14];
	let t12;
	if ($[15] !== cardNumberFormat || $[16] !== t11) {
		t12 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardNumberWrapper, {
	...
	let t13;
	if ($[18] !== cardValidityPeriodUnitString) {
		t13 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardValidityPeriodWrapper, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardValidityPeriodUnit, { children: cardValidityPeriodUnitString }) });
		$[18] = cardValidityPeriodUnitString;
		$[19] = t13;
	} else t13 = $[19];
	let t14;
	if ($[20] !== t10 || $[21] !== t12 || $[22] !== t13 || $[23] !== t3) {
		t14 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Wrapper, {
			$backgroundColor: t3,
			children: [
				t10,
				t12,
...
var CardNumberWrapper = styled.div`
  display: grid;
  grid-template-columns: ${({ $format }) => $format.map((length) => `${length}ch`).join(" ")};
  padding-inline: 1rem;
  justify-content: space-between;
  margin-top: 0.875rem;
`;
...
var arrowDownIcon_default = "data:image/svg+xml,%3csvg%20width='9'%20height='6'%20viewBox='0%200%209%206'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M0.664339%200.664322L4.48427%204.48425L8.3042%200.664323'%20stroke='black'%20stroke-width='1.32867'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e";
//#endregion
//#region src/components/common/FormField.tsx
var FormField = (t0) => {
	const $ = (0, import_compiler_runtime.c)(18);
	const { title, caption, label, helperMessage: t1, children } = t0;
	...
	let t4;
	if ($[4] !== label) {
		t4 = label && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Legend, { children: label });
		$[4] = label;
		$[5] = t4;
	} else t4 = $[5];
	let t5;
	if ($[6] !== children) {
		t5 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FieldContent, { children });
		$[6] = children;
		$[7] = t5;
	} else t5 = $[7];
	let t6;
	if ($[8] !== t4 || $[9] !== t5) {
		t6 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Fieldset, { children: [t4, t5] });
		$[8] = t4;
		$[9] = t5;
		$[10] = t6;
	} else t6 = $[10];
...
var checkExpiredValidityPeriod = (month, year) => {
...
var CardPasswordInputField = (t0) => {
	...
	const handlePasswordBlur = t2;
	const t3 = HELPER_MESSAGE$1[status];
	let t4;
	if ($[3] !== handlePasswordChange) {
		t4 = (e) => {
			const input_1 = e.target.value;
			handlePasswordChange(input_1);
		};
	...
	if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
		t5 = (e_0) => {
			const input_2 = e_0.target.value;
			handlePasswordBlur(input_2);
		};
		$[5] = t5;
	} else t5 = $[5];
	const t6 = status === "DEFAULT" ? "default" : "error";
	let t7;
	if ($[6] !== password || $[7] !== t4 || $[8] !== t6) {
		t7 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
			autoFocus: true,
			placeholder: "••",
			type: "password",
...
`;
//#endregion
//#region src/hooks/useFormStep.ts
var useFormStep = (formStep, firstStepKey) => {
	const $ = (0, import_compiler_runtime.c)(9);
	const [stepKey, setStepKey] = (0, import_react.useState)(firstStepKey);
	...
	const goToNextStep = t0;
	let t1;
	if ($[3] !== formStep || $[4] !== step) {
		t1 = (stepKey_0) => step >= formStep[stepKey_0].order;
		$[3] = formStep;
		$[4] = step;
		$[5] = t1;
	} else t1 = $[5];
	const isStepVisible = t1;
	let t2;
	if ($[6] !== goToNextStep || $[7] !== isStepVisible) {
		t2 = {
			goToNextStep,
			isStepVisible
		};
...
var AddCardCompletePage = () => {
	...
	let t0;
	if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
		t0 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CompleteCheckImage, {
			src: completeCheckImage_default,
			alt: "completeCheckImage"
		});
		$[0] = t0;
	} else t0 = $[0];
	let t1;
	...
	let t2;
	if ($[2] !== cardCompanyName || $[3] !== cardNumberPrefix) {
		t2 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CompleteTitle, { children: [
			cardNumberPrefix,
			"로 시작하는",
			t1,
			cardCompanyName,
...
var App = () => {
	...
	let t0;
	if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
		t0 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RouterProvider, { router });
		$[0] = t0;
	} else t0 = $[0];
	return t0;
};
